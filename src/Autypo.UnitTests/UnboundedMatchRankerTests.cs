...
public class UnboundedMatchRankerTests
{

    [Fact]
    public void When_has_single_result_then_it_is_returned_with_tags()
    {
        var ranker = new UnboundedMatchRanker();
    ...
    [Fact]
    public void When_has_5_different_results()
    {
        var ranker = new UnboundedMatchRanker();
