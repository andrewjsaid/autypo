...
public class SingleMatchRankerTests
{

    [Fact]
    public void When_has_single_result_then_it_is_returned_with_tags()
    {
        var ranker = new SingleMatchRanker();
    ...
    [Fact]
    public void When_result_has_worse_score_then_it_is_ignored()
    {
        var ranker = new SingleMatchRanker();
        ...
        var tags2 = AutypoTags.None;
        tags2.Set("best", false);

        ranker.Process(23, 0.01f, tags2);
    ...
    [Fact]
    public void When_processes_5_different_results()
    {
        var ranker = new SingleMatchRanker();
    ...
    [Fact]
    public void When_processes_3_different_results_with_duplicates()
    {
        var ranker = new SingleMatchRanker();
    ...
    private static AutypoTags CreateTags(int value)
    {
    ...
    private static void AssertTags(AutypoTags tags, int expected)
    {
